...
class SearchWidget extends StatelessWidget {
  const SearchWidget({Key? key,required this.onChange,this.onClear,  this.enableMargin = true,  this.hintText = "Search",required  this.textEditingController,}) : super(key: key);
...
final Function(String?) onChange;
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      margin: EdgeInsets.symmetric(horizontal: enableMargin? DimensionResource.marginSizeDefault:0),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12),side: const BorderSide(
        color:ColorResource.borderColor, width:0.6
      )),
      child: Container(
        height: 42,
        //color: Colors.red,
