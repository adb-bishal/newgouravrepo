...
class LiveFilterScreen extends StatefulWidget {
  ...
  const LiveFilterScreen({
    ...
    this.isHideSubscription = true, this.type,
  }) : super(key: key);
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: CustomLabeledDropDown(
                          ...
                          listOfData:widget.type =='live webinar' ? controller.liveDaysList: controller.daysList,
                ...
                CommonButton(
                  ...
                  onPressed: () async {
                    ...
                    if (hasSelectedFilters) {
                      ...
                      logPrint(
                          "getDateFilterData onApply ${controller.listOFSelectedDays.first.optionName}");
                    }
                  },
                  radius: 0,
