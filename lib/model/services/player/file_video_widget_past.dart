...
import 'package:stockpathshala_beta/model/services/player/widgets/custom_controls_widget_full_screen.dart';
...
class FileVideoWidgetPast extends StatefulWidget {
  ...
  const FileVideoWidgetPast({
    super.key,
    required this.url,
    this.isScalp = false,
    this.isOrientation = true,
    this.orientation = true,
    this.autoPlay = false, // Changed default to false
...
class FileVideoWidgetState extends State<FileVideoWidgetPast> {
