...
class _CustomControlsWidgetState extends State<CustomControlsWidget> {
  ...
  Widget build(BuildContext context) {
    if (widget.isScalp) {
      ...
      return Visibility(
        ...
        child: SafeArea(  // Added SafeArea here
          child: Stack(
            children: [
              Positioned(
                top: 0,
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        onTap: onHideControllers,
                                        splashColor:
                                        ColorResource.white.withOpacity(0.3),
                                        onDoubleTap: () async {
                                          ...
                                          if (videoDuration != null) {
                                            Duration rewindDuration = videoDuration -
                                          ...
                                          setState(() {
                                            if (widget.controller!.isPlaying()!) {
                                              Duration forwardDuration = Duration(
                                                  seconds: (videoDuration!.inSeconds +
                                                      10));
                                              if (forwardDuration >
                                                  widget
                                                      .controller!
                      ...
                      AnimatedOpacity(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(
                            left: 10,
                            right: 10,
                            bottom: (widget.controller?.isFullScreen ?? false) ? 25 : 5,
                          ),
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                  ...
                                  child: Container(
                                    padding: const EdgeInsets.only(top: 0, left: 6, bottom: 3),
  ...
  //               //             child: PopupMenuButton<double>(
  //               //               offset: Offset(
  //               //                   0, 40), // Controls the position of the popup
  //               //               onSelected: (speed) {
  //               //                 setState(() {
  //               //                   selectedSpeed =
  //               //                       speed; // Update selected speed
  //               //                   widget.controller?.setSpeed(speed);
  //               //                 });
  //               //               },
  //               //               itemBuilder: (context) => [
  ...
  //               //           /// Fullscreen button
  //               //           Visibility(
  //               //             visible: widget.isOrientation??true,
  //               //             child: InkWell(
  //               //               child: Container(
  //               //                 decoration: BoxDecoration(
  //               //                   borderRadius: BorderRadius.circular(15),
